...
<head>
  ...
  <title>Shop | Explore Lamsel</title>
...
<!-- 🤍 HERO SECTION - FOTO MELENGKUNG HD (Tampak Nyata) -->
<section class="relative flex items-center justify-center pt-28 pb-10 bg-white">
  <div class="max-w-4xl w-full flex justify-center">
    <div class="overflow-hidden rounded-[50px] shadow-2xl bg-white border border-gray-100">
      <img 
        src="img/umkmnaikkelas.png" 
        alt="UMKM Naik Kelas"
        class="w-full h-auto object-cover rounded-[50px] transition-transform duration-700 hover:scale-105"
        loading="lazy"
      >
    </div>
  </div>
...
<section class="py-16 bg-gray-50">
  <div class="max-w-6xl mx-auto px-6 text-center">
    <h2 class="text-2xl md:text-3xl font-bold text-gray-800 mb-12">Kategori Produk</h2>

    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">

      <!-- Kopi -->
      <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:-translate-y-1 hover:shadow-2xl transition">
        <img src="img/kopilamsel.png" alt="Kopi" class="w-full h-52 object-contain mt-5">
        <div class="p-6">
          <h3 class="text-lg font-semibold text-gray-800 mb-2">Kopi</h3>
          <p class="text-sm text-gray-500 mb-4">
            Produk Greenbean, Roasting & Bubuk dari Kopi Robusta terbaik Lampung Selatan.
          </p>
          <a href="produk.php?kategori=Kopi" 
             class="inline-block border border-gray-300 text-gray-700 text-sm font-medium px-5 py-2 rounded-full hover:bg-gray-100 hover:border-gray-400 transition">
            LIHAT PRODUK
          </a>
        </div>
      </div>
      ...
      <!-- Kerajinan -->
      <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:-translate-y-1 hover:shadow-2xl transition">
        <img src="img/kerajinanlampung.png" alt="Kerajinan Tangan" class="w-full h-52 object-contain mt-5">
        <div class="p-6">
          <h3 class="text-lg font-semibold text-gray-800 mb-2">Kerajinan Tangan</h3>
          <p class="text-sm text-gray-500 mb-4">
            Produk unik dan khas buatan tangan pengrajin terbaik dari Lampung Selatan.
          </p>
          <a href="produk.php?kategori=Kerajinan Tangan" 
             class="inline-block border border-gray-300 text-gray-700 text-sm font-medium px-5 py-2 rounded-full hover:bg-gray-100 hover:border-gray-400 transition">
            LIHAT PRODUK
          </a>
        </div>
      ...
      <!-- Oleh-Oleh -->
      <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:-translate-y-1 hover:shadow-2xl transition">
        <img src="img/oleholehlampung.png" alt="Oleh-Oleh" class="w-full h-52 object-contain mt-5">
        <div class="p-6">
          <h3 class="text-lg font-semibold text-gray-800 mb-2">Oleh-Oleh</h3>
          <p class="text-sm text-gray-500 mb-4">
            Produk khas Lampung Selatan hasil olahan petani dan pelaku UMKM lokal terbaik.
          </p>
          <a href="produk.php?kategori=Oleh-Oleh" 
             class="inline-block border border-gray-300 text-gray-700 text-sm font-medium px-5 py-2 rounded-full hover:bg-gray-100 hover:border-gray-400 transition">
            LIHAT PRODUK
          </a>
        </div>
      ...
      <!-- Fashion -->
      <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:-translate-y-1 hover:shadow-2xl transition">
        <img src="img/batiklamsel.png" alt="Fashion" class="w-full h-52 object-contain mt-5">
        <div class="p-6">
          <h3 class="text-lg font-semibold text-gray-800 mb-2">Fashion</h3>
          <p class="text-sm text-gray-500 mb-4">
            Produk busana dan aksesoris lokal modern hasil karya UMKM Lampung Selatan.
          </p>
          <a href="produk.php?kategori=Fashion" 
             class="inline-block border border-gray-300 text-gray-700 text-sm font-medium px-5 py-2 rounded-full hover:bg-gray-100 hover:border-gray-400 transition">
            LIHAT PRODUK
          </a>
        </div>
