...
<head>
  ...
  <title>Tour Packages | Explore Lamsel</title>
...
<!-- 🔵 NAVBAR UNTUK HALAMAN TOUR PACKAGE -->
  ...
  <div class="max-w-7xl mx-auto px-6 py-3">
    <div class="flex justify-between items-center bg-white rounded-xl shadow-md px-5 py-2.5 relative">
      ...
      <nav class="hidden md:flex space-x-6 text-gray-800 text-sm font-medium tracking-wide relative">
        ...
        <a href="tour.php" class="relative text-blue-600 font-semibold after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-full after:h-[2px] after:bg-blue-500">TOUR PACKAGE</a>
...
<style>
  * {
  ...
  /* Supaya link aktif (TOUR PACKAGE) tetap stabil tidak ikut animasi hover */
...
<section class="bg-white pt-32 pb-20">
  <div class="max-w-6xl mx-auto px-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-center mb-10">
      <!-- 🟣 Judul dengan gaya seperti 'Event' tapi lebih proporsional -->
      <div>
        <h2 class="text-2xl md:text-3xl font-bold text-purple-900 mb-1">Best Tour Packages</h2>
        <div class="border-b border-gray-200"></div>
      </div>

      <!-- 🔍 Search bar -->
      <div class="relative w-full sm:w-80 mt-4 sm:mt-0">
        <input id="searchInput" type="text" placeholder="🔍 Cari paket wisata..."
          class="w-full border border-gray-300 rounded-full py-2.5 px-5 text-sm focus:ring-2 focus:ring-purple-400 focus:outline-none transition" />
      </div>
    </div>

    <!-- Grid isi paket tur -->
    <div id="tourContainer" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">

      <!-- Tour 1 -->
      <div class="tour-card rounded-2xl overflow-hidden shadow-xl hover:scale-[1.04] transition-all duration-300 ease-out" data-name="kopi luna maya kampung kopi rigis">
      ...
      <!-- Tour 2 -->
      <div class="tour-card rounded-2xl overflow-hidden shadow-xl hover:scale-[1.04] transition-all duration-300 ease-out" data-name="kopi mesra kampung kopi rigis">
        <img src="img/tour2.jpg" alt="Paket Kopi Mesra" class="w-full h-72 object-cover">
        <div class="p-5 bg-white">
          <h3 class="text-xl font-semibold text-gray-800">Paket Kopi Mesra</h3>
          <p class="text-sm text-gray-500 mt-1">📍 Kampung Kopi Rigis</p>
          <p class="mt-3 font-bold text-red-600 text-lg">Rp 80.000 / person</p>
        </div>
      </div>

      <!-- Tour 3 -->
      <div class="tour-card rounded-2xl overflow-hidden shadow-xl hover:scale-[1.04] transition-all duration-300 ease-out" data-name="photo session pinus ecopark wisata foto">
