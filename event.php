...
<head>
  ...
  <title>Event - Explore Lamsel</title>
  ...
  <div class="max-w-7xl mx-auto px-6 py-3">
    <div class="flex justify-between items-center bg-white rounded-xl shadow-md px-5 py-2.5 relative">
      ...
      <nav class="hidden md:flex space-x-6 text-gray-800 text-sm font-medium tracking-wide relative">
        ...
        <a href="event.php" class="relative text-blue-600 font-semibold after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-full after:h-[2px] after:bg-blue-500">EVENT</a>
...
<style>
  * {
  ...
  /* Supaya link aktif (EVENT) tetap stabil tidak ikut animasi hover */
  ...
  <!-- 🔵 SECTION JUDUL -->
  <section class="pt-40 max-w-5xl mx-auto px-6">
    <h2 class="text-3xl md:text-4xl font-bold text-purple-900 mb-2">Event</h2>
    <div class="border-b border-gray-200 mb-10"></div>
  </section>

<!-- 🔵 EVENT CARD (Presisi, Agak Melebar & Rapi) -->
<section class="max-w-6xl mx-auto px-6 pb-20">
  <div class="flex flex-col items-center md:items-start">
    <!-- Card -->
    <div class="rounded-2xl overflow-hidden shadow-md hover:shadow-2xl hover:scale-[1.03] transition-transform duration-300 bg-white w-[480px]">
      
      <!-- 🔹 Gambar Presisi & Proporsional -->
      <div class="bg-gray-100 flex items-center justify-center h-64">
        <img src="img/beach.png" alt="Event" class="w-full h-full object-cover object-center">
      </div>

      <!-- 🔹 Konten -->
      <div class="p-6">
        <h3 class="font-bold text-gray-900 text-base uppercase mb-3 leading-snug">
          KRAKATAU BEACH RUN 2025 
        </h3>
